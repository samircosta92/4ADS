        ...
        xmlhttp.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {
                ...
                if(result== "Não existe empréstimo pendente para esse aluno!"){
                    document.getElementById("resposta").innerText = "Não existe empréstimo pendente para esse aluno!";
                }else{
                    console.log(result);//teste
                    var table = document.getElementById("table");
                    ...
                    var form = document.getElementById("formDev");
                    var button = document.createElement('button');
                    button.setAttribute('type', 'submit');
                    button.setAttribute('id', 'nome');
                    button.appendChild(document.createTextNode('Confirme a Devolução'));
                    form.appendChild(button);
                }
